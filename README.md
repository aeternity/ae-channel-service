...
buy default the command will start all tests (in parallel) found in the following [array](apps/ae_socket_connector/lib/client_runner.ex#L391), feel free to remove entries to get cleaner log outputs.
