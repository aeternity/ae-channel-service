defmodule AeChannelInterfaceWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :ae_channel_interface

  socket("/socket", AeChannelInterfaceWeb.UserSocket,
    websocket: true,
    longpoll: false
  )
