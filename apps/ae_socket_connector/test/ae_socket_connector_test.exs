defmodule SocketConnectorTest do
  ...
  test "hello fsm mini", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1401})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "abort transfer", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1402})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "close on chain", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1403})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "close on chain maliscous", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1404})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "withdraw after re-establish", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1405})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "close solo", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1406})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "reestablish jobs 2", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1407})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "contract jobs", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 0, port: 1408})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
  ...
  test "teardown on channel creation", context do
    ...
    channel_config = ClientRunner.ClientRunner.custom_config(%{}, %{minimum_depth: 50, port: 1409})
    ClientRunner.start_peers(
      @ae_url,
      @network_id,
      %{
